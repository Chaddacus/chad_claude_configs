...
7. **Handoff terminator (truncation tripwire).** End the report with the literal final line `HANDOFF-COMPLETE` — written only after step 6's full report. The hub treats a result missing this line as a truncated/failed dispatch and respawns.
