...
- "Where should I create this skill? If you do not have a preference, I will place it in `$CLAUDE_HOME/skills` (or `~/.claude/skills` when `CLAUDE_HOME` is unset) so Claude can discover it automatically."
...
```bash
scripts/init_skill.py my-skill --path "${CLAUDE_HOME:-${CODEX_HOME:-$HOME/.claude}}/skills"
scripts/init_skill.py my-skill --path "${CLAUDE_HOME:-${CODEX_HOME:-$HOME/.claude}}/skills" --resources scripts,references
