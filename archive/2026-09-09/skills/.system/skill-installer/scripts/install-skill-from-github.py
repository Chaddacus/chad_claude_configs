#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into the active user skill home."""
...
def _codex_home() -> str:
    return os.environ.get("CLAUDE_HOME") or os.environ.get("CODEX_HOME") or os.path.expanduser("~/.claude")
